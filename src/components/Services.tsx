        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {Services.map((service) => (
            ...
            >
              ...
              <a href="#" className="mt-4 inline-block bg-gradient-to-r from-customPink to-customBlue text-black font-semibold py-2 px-4 rounded-full transform transition-transform duration-300 hover:scale-105">
                Read More
              </a>
            </div>
          ))}
