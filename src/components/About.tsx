  ...
  return (
    <div className="bg-black text-white py-20" id="about">
      ...
      <div className="flex flex-col md:flex-row items-center md:space-x-12">
        {/* Image Section */}
        <div 
          className="w-72 h-80 ml-24 rounded-lg object-cover mb-8 md:mb-0 sm:mx-9 lg:ml-24"
          data-aos="fade-right"
        >
          <Image 
            src="/pl.png" 
        ...
        <div className="flex-1" data-aos="fade-left">
          ...
          <div className="space-y-4 mb-24">
            ...
            <div className="flex items-center" data-aos="fade-up" data-aos-delay="600">
              <label htmlFor="nextjs" className="w-1/12">Next JS</label>
              <div className="grow bg-gray-800 rounded-full h-2.5">
                <div className="bg-gradient-to-r from-customPink to-customBlue h-2.5 rounded-full transform transition-transform duration-300 hover:scale-105 w-9/12"></div>
              </div>
            </div>
          ...
          {/* Stats Section */}
          <div className="mt-12 mb-24 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 text-center">
